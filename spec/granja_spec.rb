RSpec.describe Granja do
  ...
  describe Granja::Funcion do
    ...
    it "Tiene un metodo para poder imprimir" do
      expect(Granja::Funcion.new("Saludables","Buena","10").to_s).to eq("Las condiciones de vida de los animales son: Saludable \n La calidad de los cuidados es Buena \n y el nivel de reproduccion es 10")
      expect(Granja::Funcion.new("Saludables","Mala","5").to_s).to eq("Las condiciones de vida de los animales son: Saludable \n La calidad de los cuidados es Mala \n y el nivel de reproduccion es 5")
