...
RSpec.describe Granja do
    describe Granja::DSLGranja do
        ...
        granja_2 = Granja::DSLGranja.new(12345679) do
            dato "Cabras vivos",
        ...
        granja_3 = Granja::DSLGranja.new(12345610) do
            dato "Ovejas gucci",
        ...
        context "Atributos de la clase Datos" do
            ...
            it "Tiene un variable para almacenar los datos" do
                ...
                expect(granja_2.datos).to eq([12345679, "Cabras vivos", "ME - mediana empresa", :caprino])
                expect(granja_3.datos).to eq([12345610, "Ovejas gucci", "G - gran empresa", :ovino])
            end
            ...
            it "Se obtiene una cadena con la informacion de la granja correctamente formateada" do
                ...
                expect(granja_2.to_s).to eq( "La granja de identificacion 12345679 , con los datos de nombre Cabras vivos, descripcion ME - mediana empresa y tipo caprino\n\nTiene los siguientes ejemplares: \n\nEjemplar 1 Su identificador es 12345679-00000002, su edad es 327,su peso es 825.3 , su precio de compra 3.18, y de venta es 6.89\nEjemplar 2 Su identificador es 12345679-00000003, su edad es 567,su peso es 1350.4 , su precio de compra 1.25, y de venta es 2.75\n")
                expect(granja_3.to_s).to eq( "La granja de identificacion 12345610 , con los datos de nombre Ovejas gucci, descripcion G - gran empresa y tipo ovino\n\nTiene los siguientes ejemplares: \n\nEjemplar 1 Su identificador es 12345679-00000002, su edad es 365,su peso es 700.2 , su precio de compra 4.25, y de venta es 4.75\nEjemplar 2 Su identificador es 12345679-00000008, su edad es 465,su peso es 1200.2 , su precio de compra 1.25, y de venta es 2.75\n")
            end
        end
